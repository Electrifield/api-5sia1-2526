...
/**
 * API Resources untuk model Product
 */
//1. ambil semua data produk beserta pemilik nya (user)
...
//method: GET
    ...
    // $users = User::all();
    // method with() digunakan untuk menyertakan relasi
    // relasi yang di sebutkan adalah nama method pada model
...
// method: GET
    ...
    //cari user tanpa relasi ke tabel produk
